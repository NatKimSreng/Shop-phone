...
<div class="bg-gray-50 py-12">
    <div class="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        {{-- Header Section --}}
        <div class="mb-12">
            <h1 class="text-5xl md:text-6xl font-black text-center mb-4">All Products</h1>
        ...
        <div class="mb-10 bg-white rounded-3xl p-6 shadow-lg">
            <form action="{{ route('frontend.products.index') }}" method="GET" class="flex flex-col md:flex-row gap-4">
                <input
                    type="text"
                    name="q"
                ...
                >
                <select name="category" class="px-6 py-4 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-black">
                ...
                @if(request()->hasAny(['q', 'category']))
                    <a href="{{ route('frontend.products.index') }}" class="px-8 py-4 bg-gray-200 text-black font-bold rounded-xl hover:bg-gray-300 transition">
                        Clear
                    </a>
                @endif
            </form>
